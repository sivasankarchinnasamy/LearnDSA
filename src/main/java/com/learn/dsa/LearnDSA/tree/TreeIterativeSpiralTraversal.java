...
/* Problem: Java program for iterative level order traversal in spiral form
 * Reference: https://www.geeksforgeeks.org/level-order-traversal-in-spiral-form/
 * */ 

class TreeIterativeSpiralTraversal { 
	...
	{ 
		TreeIterativeSpiralTraversal tree = new TreeIterativeSpiralTraversal(); 
