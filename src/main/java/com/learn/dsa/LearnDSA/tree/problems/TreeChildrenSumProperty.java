...
/* Problem: Java program to check children sum property
 * Reference: https://www.geeksforgeeks.org/check-for-children-sum-property-in-a-binary-tree/
 * */ 

class TreeChildrenSumProperty 
{ 
	Node root; 
	...
	{ 
		TreeChildrenSumProperty tree = new TreeChildrenSumProperty(); 
