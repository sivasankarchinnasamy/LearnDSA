...
/* Problem: Java program for recursive level order traversal in spiral form
 * Reference: https://www.geeksforgeeks.org/level-order-traversal-in-spiral-form/
 * */ 

class TreeRecursiveSpiralTraversal { 
	Node root; 
	...
	{ 
		TreeRecursiveSpiralTraversal tree = new TreeRecursiveSpiralTraversal(); 
